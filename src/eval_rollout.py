...
from agents import StudentSeed, LLM, Student, Teacher, Judge, OllamaAgent, MCTSTeacher
...
if __name__ == "__main__":
    ...
    # TODO: how to manage multuple llms
    parser.add_argument(
        "--ollama_address", nargs=3, action=LLMAction,
        help="...",
    ...
    # TODO: we need this guys
    gpt4o = ...
    nemo = Teacher(OllamaAgent("mistral-nemo:12b-instruct-2407-fp16", ollama.Client(args.ollama_address)))
    mcts = MCTSTeacher(OllamaAgent("mistral-nemo:12b-instruct-2407-fp16", ollama.Client(args.ollama_address)))
    socratic_llm = ...  # https://ollama.com/eurecom-ds/phi-3-mini-4k-socratic
    learn_llm = ...  # from Google: bonus of the bonus of the bonus
    ...
    for teacher in [gpt4o, nemo, mcts, socratic_llm, learn_llm]:
        # TODO: implement the loop
        #       create a new "InteractionsDataset" which also specifies the source llm
        #       store each of these files
        ...
    ...
    # TODO: loop for all new InteractionsDatasets and evaluate one by one.
    if evaluations_path.exists():
