...
class ActionValueFunctionModel(ModernBertForSequenceClassification):
    def __init__(self, config: ModernBertConfig):
        ...
        print("FFN1 weight std:", np.array(self.ffn1.weight))
        print("FFN2 weight std:", np.array(self.ffn2.weight))
    ...
    def forward(
        ...
        pooled_output = self.ffn_dropout(self.ffn2(self.activation(self.ffn1(pooled_output))))
        print(pooled_output)
